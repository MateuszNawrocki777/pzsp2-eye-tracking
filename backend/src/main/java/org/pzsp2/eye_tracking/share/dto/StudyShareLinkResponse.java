...
@Data public class StudyShareLinkResponse {

    @JsonProperty("access_link") private String accessLink;
    ...
    @JsonProperty("use_counter") private Integer useCounter;

    @JsonProperty("access_url") private String accessUrl;
}
