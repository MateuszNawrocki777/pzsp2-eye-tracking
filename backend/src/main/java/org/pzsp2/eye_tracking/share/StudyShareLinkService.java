...
public class StudyShareLinkService {
  ...
  public StudyShareLinkService(
      StudyShareLinkRepository shareLinkRepository,
  ...
  public StudyShareLinkResponse createShareLinkForResearcher(
  ...
  public TestDetailsDto getTestDetailsForShareLink(String accessLink) {
    StudyShareLink link =
        shareLinkRepository
            .findById(Objects.requireNonNull(accessLink))
