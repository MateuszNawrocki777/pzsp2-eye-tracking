...
@SuppressFBWarnings(value = {"EI_EXPOSE_REP",
                "EI_EXPOSE_REP2"}, justification = "JPA entities are mutable by design") public class StudySession {
    ...
    @Column(name = "session_name") private String name;

    @Column(name = "completed_at") private LocalDateTime completedAt = LocalDateTime.now();

    @Lob
    @Column(name = "heatmaps_json", columnDefinition = "TEXT") private String heatmapsJson;
}