    ...
    public void run(ApplicationArguments args) {
        ...
        userAccountRepository.findByEmailIgnoreCase(email)
                .ifPresentOrElse(existing -> {
                    ...
                    if (!passwordService.matches(adminUserProperties.password(), existing.getPasswordHash())) {
                        existing.updatePasswordHash(passwordService.hashPassword(adminUserProperties.password()));
