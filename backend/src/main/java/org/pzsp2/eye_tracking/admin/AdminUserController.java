...
public class AdminUserController {
  ...
  @GetMapping
  public List<AdminUserResponse> listOtherUsers(
  ...
  @ResponseStatus(HttpStatus.OK)
  public AdminUserResponse updateBanned(
      @PathVariable UUID userId, @Valid @RequestBody UpdateUserBannedRequest request) {
