...
public class AdminUserController {
    ...
    @GetMapping
    public List<AdminUserResponse> listOtherUsers(@AuthenticationPrincipal AuthenticatedUser adminUser) {
    ...
    public AdminUserResponse updateRole(@PathVariable UUID userId,
    ...
    @ResponseStatus(HttpStatus.OK)
    public AdminUserResponse updateBanned(@PathVariable UUID userId,
