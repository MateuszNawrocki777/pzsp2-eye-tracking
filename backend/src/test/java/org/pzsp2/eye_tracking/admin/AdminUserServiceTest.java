...
@ExtendWith(MockitoExtension.class) class AdminUserServiceTest {

    @Mock private UserAccountRepository userAccountRepository;

    @InjectMocks private AdminUserService service;

    @Test void getAllOtherUsers_filtersOutCurrentUser() {
    ...
    @Test void getAllOtherUsers_returnsAll_whenCurrentUserIdIsNull() {
    ...
    @Test void updateBanned_throwsNotFound() {
        UUID userId = UUID.randomUUID();
        given(userAccountRepository.findById(userId)).willReturn(Optional.empty());
